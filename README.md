...
Este projeto foi desenvolvido com o propósito de realizar o teste técnico do processo seletivo da SHARENERGY 2023/01.

Para acessar o video de apresentação, [clique aqui!](https://www.youtube.com/watch?v=4PNcrZ4_TDQ)

## 📄 Descrição
A RandomAPI trata-se de uma aplicação web (frontend e backend), capaz de realizar a comunicação com APIs distinstas, além de um CRUD. Para a conclusão do desafio, foram solicitados os pré-requisitos:
